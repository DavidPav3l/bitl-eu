...
const text = {
  ...
  "object_criticality" (Importance or necessity of the standard materials used for that object, in relation to ,alternative, eco friendly materials. 1 means very high dependence on standard materials, 5 means very low);
